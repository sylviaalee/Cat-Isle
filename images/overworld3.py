...
def main_screen():
    ...
    while loop:
        ...
        if x < -5 and x > -300 and y < 15 and y > -300 and keys[pygame.K_RETURN] and SCREEN == "main":
            SCREEN = "game1"
        
        if x < 2000 and x > 1100 and y < 30 and y > -200 and keys[pygame.K_RETURN] and SCREEN == "main":
            SCREEN = "game2"

        if x < 2000 and x > 1100 and y < 2000 and y > 475 and keys[pygame.K_RETURN] and SCREEN == "main":
            SCREEN = "game3"

        if x < -5 and x > -300 and y < 2000 and y > 475 and keys[pygame.K_RETURN] and SCREEN == "main":
            SCREEN = "game4"
